...
export class Batsman extends Player {
  ...
  getStrikeRate() {
    ...
    const total = this.innings.reduce((total,inning) => total + inning.strikeRate,0)
...
export class Bowler extends Player {
  ...
  getEconomy() {
   ...
   for(let i =0 ; i< this.spells.length; i++ ){
    totalEcnomy += this.spells[i].economy
   }
    return totalEcnomy/this.spells.length
  }
...
export class AllRounder extends Player {
  ...
  getStrikeRate() {
    ...
    for(let i =0; i < this.innings.length; i++){
      totalStrikeRate += this.innings[i].strikerate
    }
  ...
  getEconomy() {
    ...
    let totalEconomy = 0;
    for(let i =0; i < this.spells.length; i++){
      totalEconomy += this.spells[i].economy
    }
